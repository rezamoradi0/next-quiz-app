...
function TextArea({tab,cols="30", rows="10",id ,dir="ltr" ,className=""}) {
    ...
    return (
        <div  dir={dir}  className="flex flex-col grow-0  items-start justify-start w-full group overflow-hidden focus-within:border-sky-500 focus-within:border rounded-lg">
            ...
            <textarea  name={id} id={id} cols={cols} rows={rows} className={twMerge("w-full resize-none bg-zinc-700  p-8 outline-none",className)} ></textarea>
        </div>
    )
}
